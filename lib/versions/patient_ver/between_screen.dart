...
class _BetweenScreenState extends State<BetweenScreen> {
  ...
  void autoGoHome() async{
    await Future.delayed(const Duration(seconds: 3), () => goHome());
  }
  void goHome(){
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            const Spacer(flex: 1,),
            Lottie.asset("assets/lottie/bluetooth_connection.json", height: MediaQuery.of(context).size.height * 0.5),
